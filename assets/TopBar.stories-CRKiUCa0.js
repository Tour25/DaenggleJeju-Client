import{j as e}from"./jsx-runtime-CNHGY5eS.js";import{n as l}from"./image-BuzQsCPt.js";import"./iframe-Cn4TxATR.js";import"./preload-helper-D9Z9MdNV.js";var y="sngi910",b="sngi911",p="sngi913",f="sngi914 sngi913",x="sngi915",T="sngi916",I="sngi917";function g({backIconHandler:s,title:a,isShowLogo:c=!1,rightIcons:m=[],sticky:u=!1,className:h}){return e.jsxs("header",{className:[y,u&&b,h].filter(Boolean).join(" "),role:"banner",children:[e.jsx("div",{className:f,children:s?e.jsx("button",{type:"button",className:p,onClick:s,"aria-label":"뒤로가기",children:e.jsx(l,{src:"/assets/icon24/arrow-left_line.svg",alt:"뒤로가기",width:24,height:24})}):null}),e.jsx("div",{className:x,"aria-live":"polite",children:c?e.jsx(l,{src:"/assets/logo/logo-top.svg",alt:"댕글 로고",width:72.56,height:24}):a?e.jsx("div",{className:T,title:a,children:a}):null}),e.jsx("nav",{className:I,"aria-label":"topbar-actions",children:m.map(({icon:k,onClick:v},d)=>e.jsx("button",{type:"button",className:p,onClick:v,"aria-label":`action-${d+1}`,children:k},d))})]})}g.__docgenInfo={description:`TopBar
...
}`,...i.parameters?.docs?.source}}};const _=["WithLogo","WithAction","TitleOnly","All"];export{i as All,t as TitleOnly,n as WithAction,o as WithLogo,_ as __namedExportsOrder,S as default};
